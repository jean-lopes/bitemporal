...
select * from bitemporal.save_s('s-for-fk-000', 1, '[3,6]');
...
select * from bitemporal.save_s('s-for-fk-001', 1, '[3,6]');
...
select * from bitemporal.save_s('s-for-fk-002', 1, '[2,3]');
select * from bitemporal.save_s('s-for-fk-002', 2, '[4,5]');
select * from bitemporal.save_s('s-for-fk-002', 3, '[6,7]');
...
select * from bitemporal.save_s('s-for-fk-003', 1, '[2,3]');
select * from bitemporal.save_s('s-for-fk-003', 2, '[4,5]');
select * from bitemporal.save_s('s-for-fk-003', 3, '[6,7]');
