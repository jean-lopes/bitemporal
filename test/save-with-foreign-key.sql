...
call save_sp('s-for-fk-1', 'save-with-foreign-key-000', 0, 'empty');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-001', 1, '[3,6]');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-002', 1, '[0,9]');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-003', 1, '[0,3]');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-004', 1, '[6,9]');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-005', 1, '[0,1]');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-006', 1, '[8,9]');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-007', 1, '(,)');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-008', 1, '(,3]');
...
call save_sp('s-for-fk-1', 'save-with-foreign-key-009', 1, '[6,)');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-010', 1, '[3,6]');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-011', 1, '[0,9]');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-012', 1, '[0,3]');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-013', 1, '[6,9]');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-014', 1, '[0,1]');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-015', 1, '[8,9]');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-016', 1, '(,)');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-017', 1, '(,3]');
...
call save_sp('s-for-fk-2', 'save-with-foreign-key-018', 1, '[6,)');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-019', 1, '[3,6]');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-020', 1, '[0,9]');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-021', 1, '[0,3]');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-022', 1, '[6,9]');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-023', 1, '[0,1]');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-024', 1, '[8,9]');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-025', 1, '(,)');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-026', 1, '(,3]');
...
call save_sp('s-for-fk-3', 'save-with-foreign-key-027', 1, '[6,)');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-028', 1, '[3,6]');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-029', 1, '[0,9]');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-030', 1, '[0,3]');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-031', 1, '[6,9]');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-032', 1, '[0,1]');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-033', 1, '[8,9]');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-034', 1, '(,)');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-035', 1, '(,3]');
...
call save_sp('s-for-fk-4', 'save-with-foreign-key-036', 1, '[6,)');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-037', 1, '[3,6]');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-038', 1, '[0,9]');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-039', 1, '[0,3]');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-040', 1, '[6,9]');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-041', 1, '[0,1]');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-042', 1, '[8,9]');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-043', 1, '(,)');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-044', 1, '(,3]');
...
call save_sp('s-for-fk-5', 'save-with-foreign-key-045', 1, '[6,)');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-046', 1, '[3,6]');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-047', 1, '[0,9]');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-048', 1, '[0,3]');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-049', 1, '[6,9]');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-050', 1, '[0,1]');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-051', 1, '[8,9]');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-052', 1, '(,)');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-053', 1, '(,3]');
...
call save_sp('s-for-fk-6', 'save-with-foreign-key-054', 1, '[6,)');
...
call save_s('s-for-fk-7', 1, '[0,10]');
call save_sp('s-for-fk-7', 'save-with-foreign-key-055', 1, '[0,10]');
call save_s('s-for-fk-7', 2, '[4,6]');
...
call save_s('s-for-fk-8', 1, '[0,10]');
call save_sp('s-for-fk-8', 'save-with-foreign-key-056', 1, '[0,10]');
call save_sp('s-for-fk-8', 'save-with-foreign-key-056', 2, '[4,6]');
