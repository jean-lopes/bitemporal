...
select * from  bitemporal.save_s('save-000', 0, 'empty');

\echo 'save-001 - [uuuu]'
insert into s(id, value, valid_period) values ('save-001', 1, '[,)');
select * from  bitemporal.save_s('save-001', 0, '[,)');
...
select * from  bitemporal.save_s('save-002', 0, '[,55)');
...
select * from  bitemporal.save_s('save-003', 0, '[25,)');
...
select * from  bitemporal.save_s('save-004', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-005', 0, '[,)');
...
select * from  bitemporal.save_s('save-006', 0, '[,55)');
...
select * from  bitemporal.save_s('save-007', 0, '[25,)');
...
select * from  bitemporal.save_s('save-008', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-009', 0, '[,)');
...
select * from  bitemporal.save_s('save-010', 0, '[,55)');
...
select * from  bitemporal.save_s('save-011', 0, '[25,)');
...
select * from  bitemporal.save_s('save-012', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-013', 0, '[,)');
...
select * from  bitemporal.save_s('save-014', 0, '[,55)');
...
select * from  bitemporal.save_s('save-015', 0, '[25,)');
...
select * from  bitemporal.save_s('save-016', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-017', 0, '[,)');
...
select * from  bitemporal.save_s('save-018', 0, '[,55)');
...
select * from  bitemporal.save_s('save-019', 0, '[25,)');
...
select * from  bitemporal.save_s('save-020', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-021', 0, '[,)');
...
select * from  bitemporal.save_s('save-022', 0, '[,55)');
...
select * from  bitemporal.save_s('save-023', 0, '[25,)');
...
select * from  bitemporal.save_s('save-024', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-025', 0, '[,)');
...
select * from  bitemporal.save_s('save-026', 0, '[,55)');
...
select * from  bitemporal.save_s('save-027', 0, '[25,)');
...
select * from  bitemporal.save_s('save-028', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-029', 0, '[,)');
...
select * from  bitemporal.save_s('save-030', 0, '[,55)');
...
select * from  bitemporal.save_s('save-031', 0, '[25,)');
...
select * from  bitemporal.save_s('save-032', 0, '[25,55)');
select id, value, valid_period from s where id = 'save-032' order by valid_period;

\echo 'save-033 - [----]'
select * from  bitemporal.save_s('save-033', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-034', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-035', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-036', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-037', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-038', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-039', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-040', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-041', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-042', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-043', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-044', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-045', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-046', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-047', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-048', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-049', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-050', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-051', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-052', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-053', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-054', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-055', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-056', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-057', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-058', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-059', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-060', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-061', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-062', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-063', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-064', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-065', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-066', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-067', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-068', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-069', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-070', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-071', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-072', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-073', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-074', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-075', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-076', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-077', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-078', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-079', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-080', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-081', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-082', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-083', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-084', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-085', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-086', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-087', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-088', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-089', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-090', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-091', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-092', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-093', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-094', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-095', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-096', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-097', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-098', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-099', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-100', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-101', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-102', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-103', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-104', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-105', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-106', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-107', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-108', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-109', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-110', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-111', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-112', 0, '[25,55)');
...
select * from  bitemporal.save_s('save-113', 0, '[25,55)');
